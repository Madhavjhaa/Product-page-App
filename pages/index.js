...
export default function Home() {
  ...
  let items = ['all bags', 'Vanity Pouch', 'Tote Bag','Duffle Bag', 'Laptop Sleeve', 'Messanger Bags','Slings Bags','Hand Bags','Bucket Bags'];
  let imagesOfBags=['bag1.png','vanity.png','3rd.png','duffle.png','laptop.png','mess.png','sli.png','hand.png','last.png']
        ...
        <div id="menu">
          ...
          {items.map(function (name, index) {
            return (<div key={index} id="menuitem">
              ...
              <img width="100px" height="100px" src={imagesOfBags[index]} />
              </div>
